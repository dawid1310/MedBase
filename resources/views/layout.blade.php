        ...
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between"
                ...
                <div class="navbar align-self-center d-flex">
                    ...
                    <div class="dropdown">
                        <a class="bx bx-user-circle bx-sm text-primary" data-bs-toggle="dropdown" aria-expanded="false"
                            data-bs-display="static">
                        </a>
                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-dark" aria-labelledby="dropdownMenu2">
                            @guest
                                <li>
                                    <a class="dropdown-item btn-outline-primary rounded-pill px-3"
                                        href="/login">Logowanie/Rejestracja</a>
                                </li>
                            @else
                                <li>
                                    <div class="dropdown-item  btn-outline-primary rounded-pill"> Witaj
                                ...
                                <li>
                                    <a class="dropdown-item  btn-outline-primary rounded-pill"
                                        href="{{ route('logout') }}"
                            ...
                            <li><a class="dropdown-item btn-outline-primary rounded-pill px-3" href="/login">coś
                                    innego</a></li>
                            @auth
                                <li class="nav-item">
                                    <a class="nav-link btn-outline-primary rounded-pill px-3" href="/manage">Recepcja</a>
            ...
            <div class="row py-4">
                ...
                <div class="col-lg-3 col-md-4 my-sm-0 mt-4">
                    ...
                    <ul class="list-unstyled text-light light-300">
                        ...
                        <li class="pb-2">
                            <i class='bx-fw bx bx-mail-send bx-xs'></i><a class="text-decoration-none text-light py-1"
                                href="/doctors-registration">Zostań lekarzem naszego serwisu</a>
                        </li>
                    </ul>
                </div>
